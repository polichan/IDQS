  ...
  <div class="container">
   ...
   <div class="panel panel-danger">
    <div class="panel-heading">
     <h3 class="panel-title"> <span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span> &nbsp;公告</h3>
    </div>
...
margin-top: 20px;">
    <div class="panel-heading">
     <h3 class="panel-title"> <span class="glyphicon glyphicon-bell" aria-hidden="true"></span> &nbsp;更新日志</h3>
    </div>
    <div class="panel-body">
      v2.0.1 :
     <br />
     <li>优化了数据库</li>
     <li>修正了出现重复名字时，不能全部显示的问题</li> v2.0.0 :
     <br />
     <li>新版本上线</li>
    </div>
   </div>
   <div class="panel panel-default panel-top">
    <div class="panel-body">
     <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> 开发人：陈鹏宇
    </div>
    <div class="panel-footer">
      如果你不嫌烦的话，可以考虑看看&nbsp;
     <a href="https://7float.com/">我的博客</a>
     <br /> Developed on Feb.4th | Current Version: 2.0.1 STABLE &nbsp;
     <!--CNZZ数据统计 -->
